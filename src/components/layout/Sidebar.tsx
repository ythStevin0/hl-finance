...
const navItems = [
  {
    ...
    exact: true,
    icon: (
      <svg className="sidebar-icon" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        ...
        <button onClick={handleLogout} className="sidebar-logout">
          <svg className="sidebar-icon-sm" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
